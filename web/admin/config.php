...
<div class="container-fluid">
    ...
    <form id="form1" name="form1" method="post" action="config_save.php">
        <div class="form-group">
            <div class="input-group mb-3">
                <div class="input-group-append  col-md-2">
                    <label for="site_title"><span style="color:#F30">*</span>网站标题：</label>
                </div>
        ...
        <div class="form-group">
            <div class="input-group mb-3">
                <div class="input-group-append  col-md-2">
                    <label for="company_ewm">公司二维码：</label>
                </div>
        ...
        <div class="form-group">
            <div class="input-group mb-3">
                <div class="input-group-append  col-md-2">
                    <label for="site_url"><span style="color:#F30">*</span>网站地址：</label>
                </div>
        ...
        <div class="form-group">
            <div class="input-group mb-3">
                <div class="input-group-append  col-md-2">
                    <label for="site_copyright">底部版权信息（支持html标记）：</label>
                </div>
        ...
        <div class="form-group">
            <div class="input-group mb-3">
                <div class="input-group-append  col-md-2">
                    <label for="company_email">电子邮箱：</label>
                </div>
        ...
        <div class="form-group">
            <div class="input-group mb-3">
                <div class="input-group-append  col-md-2">
                    <label for="company_email">微信：</label>
                </div>
